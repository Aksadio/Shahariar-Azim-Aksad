...
const PROJECTS = [
  {
    ...
    href: "https://github.com/Aksadio/password-generator",
    kind: "GitHub",
  ...
  {
    name: "DevMood",
    href: "https://github.com/Aksadio/devmood",
    kind: "GitHub",
    note: "Analyzes a developer's mood from their Git commit messages.",
  },
  {
    name: "Constellation Explorer",
    href: "https://github.com/Aksadio/constellation-explorer",
    kind: "GitHub",
  ...
  {
    name: "Hacker Console",
    href: "https://github.com/Aksadio/hacker-console",
    kind: "GitHub",
    note: "A restricted-access hacker terminal with a 3D animated login dashboard.",
  },
  {
    name: "MarkFlow",
    href: "https://github.com/Aksadio/markflow",
    kind: "GitHub",
    note: "A minimal, AI-powered Markdown notes app — built with vanilla HTML, CSS, and JavaScript.",
  },
  {
    name: "QR",
    href: "https://github.com/Aksadio/QR",
    kind: "GitHub",
  ...
  {
    name: "Aksad",
    href: "https://github.com/Aksadio/Aksad",
    kind: "GitHub",
